    ...
    <View style={styles.container}>
      ...
      <View style={styles.containerGuides}>
        <CardItem
          onPress={async () =>
            await Linking.openURL(
              'https://jericoxnavarro.github.io/react-native-boilerplate/docs/Navigation',
            )
          }
          title="Navigation"
        ...
        <CardItem
          onPress={async () =>
            await Linking.openURL(
              'https://jericoxnavarro.github.io/react-native-boilerplate/docs/UsingFlipper',
            )
          }
          title="Flipper"
      ...
      <View style={styles.containerGuides}>
        <CardItem
          ...
          onPress={async () =>
            await Linking.openURL(
              'https://jericoxnavarro.github.io/react-native-boilerplate/docs/BetaBuild',
            )
          }
        />
        <View style={styles.seperator} />
        <CardItem
          onPress={async () =>
            await Linking.openURL(
              'https://jericoxnavarro.github.io/react-native-boilerplate/docs/Components',
            )
          }
          title="Components"
      ...
      <TouchableOpacity
        onPress={async () =>
          await Linking.openURL(
            'https://jericoxnavarro.github.io/react-native-boilerplate/',
          )
        }
        style={styles.state}
      >
